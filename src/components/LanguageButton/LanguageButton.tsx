...
const LanguageButton = ({ color, className, transparent }: Props) => {
  ...
  return (
    <Link href={router.pathname} locale={router.locale === ro ? ru : ro}>
      <a className={classNames(styles.languageButtonContainer, 'flex justify-center items-center font-bold group', className)}>
